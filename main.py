...
print(' ' * 28 + 'Погр. N:' + ' ' * 11 + 'Погр. 2N:' + ' ' * 10 + 'Отношение:' + ' ' * 10 + 'Уточнение(погр.):')
print(
    f'Левые прямоугольники:       {abs(main_integral - integral_left):.10f}  |    {abs(main_integral - integral_left2):.10f}  |     {(abs(main_integral - integral_left) / abs(main_integral - integral_left2)):7.2f}       |   {abs(main_integral - integral_left_improve)}\n'
    f'Центральные прямоугольники: {abs(main_integral - integral_mid):.10f}  |    {abs(main_integral - integral_mid2):.10f}  |     {(abs(main_integral - integral_mid) / abs(main_integral - integral_mid2)):7.2f}       |   {abs(main_integral - integral_mid_improve)}\n'
    f'Трапеции:                   {abs(main_integral - integral_trap):.10f}  |    {abs(main_integral - integral_trap2):.10f}  |     {(abs(main_integral - integral_trap) / abs(main_integral - integral_trap2)):7.2f}       |   {abs(main_integral - integral_trap_improve)}\n'
    f'Метод Симпсона:             {abs(main_integral - integral_simp):.10f}  |    {abs(main_integral - integral_simp2):.10f}  |     {(abs(main_integral - integral_simp) / abs(main_integral - integral_simp2)):7.2f}       |   {abs(main_integral - integral_simp_improve)}\n'
    f'Метод Гаусса (2):           {abs(main_integral - integral_gauss2):.10f}  |    {abs(main_integral - integral_gauss2u2):.10f}  |     {(abs(main_integral - integral_gauss2) / abs(main_integral - integral_gauss2u2)):7.2f}       |   {abs(main_integral - integral_gauss2_improve)}\n'
    f'Метод Гаусса (3):           {abs(main_integral - integral_gauss3):.10f}  |    {abs(main_integral - integral_gauss3u2):.10f}  |     {(abs(main_integral - integral_gauss3) / abs(main_integral - integral_gauss3u2)):7.2f}       |   {abs(main_integral - integral_gauss3_improve)}\n')
